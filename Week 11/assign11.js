...
function calcTotal() {
	...
	if (document.getElementById("addA").checked)
		totalA = document.getElementById("qtyA").value*14.99;
	if (document.getElementById("addB").checked)
		totalB = document.getElementById("qtyB").value*24.99;
	if (document.getElementById("addC").checked)
		totalC = document.getElementById("qtyC").value*15.99;
	if (document.getElementById("addD").checked)
		totalD = document.getElementById("qtyD").value*34.99;
